...
class _$AddAddressImpl implements _AddAddress {
  ...
  @override
  String toString() {
    return 'AddAddressEvent.addAddress(name: $name, address: $address, phone: $phone, provinceId: $provinceId, cityId: $cityId, subdistrictId: $subdistrictId, provinceName: $provinceName, cityName: $cityName, subdistrictName: $subdistrictName, zipCode: $zipCode, userId: $userId, isDefault: $isDefault)';
  }
